(function () {
	...
	function ctrol() {
		this.musicWrap = document.querySelector('.musicWrap');  //总的音乐文件
		...
		this.musicName = this.musicWrap.querySelector('.musicName');  //歌名
		this.musicArtist = this.musicWrap.querySelector('.musicArtist');  //歌手
		this.totalTime = this.musicWrap.querySelector('.totalTime');  //总时间
		this.nowTime = this.musicWrap.querySelector('.nowTime');  //播放到的事件
		this.divs = this.musicWrap.querySelector('.header div'); // 歌名加歌手
